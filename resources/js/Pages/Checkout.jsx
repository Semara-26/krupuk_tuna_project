...
export default function Checkout() {
    ...
    const submit = (e) => {
        e.preventDefault();
        // Untuk sekarang, kita hanya log data ke console
        // Nanti, 'post(route('order.store'))' akan mengirim data ini ke backend
        console.log("Data yang akan dikirim:", data);
        alert("Proses lanjut ke pembayaran! (Cek console untuk detail data)");
    };
